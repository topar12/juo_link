...
import PetbtiProductsManager from '@/features/admin/components/PetbtiProductsManager';
  ...
  return (
    <div className="min-h-screen bg-[#09090B] text-white">
      ...
      <div className="ml-[240px]">
        {/* 음식·매장·멍BTI추천 데이터 뷰는 프로젝트가 아니므로 프로젝트 조회보다 먼저 분기한다. */}
        {activeView === 'foods' ? (
          <FoodsManager />
        ) : activeView === 'stores' ? (
          <StoresManager />
        ) : activeView === 'petbti-products' ? (
          <PetbtiProductsManager />
        ) : activeProject ? (
